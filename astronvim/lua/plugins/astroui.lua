  ...
  opts = {
    ...
    highlights = {
      init = { -- this table overrides highlights in all themes
        ...
        NeoTreeTabSeperatorActive = { fg = "#202020", bg = "none" },
        NeoTreeTabSeperatorInactive = { fg = "#202020", bg = "none" },
        NvimTreeTabSeperatorActive = { fg = "#202020", bg = "none" },
        NvimTreeTabSeperatorInactive = { fg = "#202020", bg = "none" },
